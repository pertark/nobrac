    ...
    <header className="fixed top-0 w-full clearNav z-50">
      <div className="max-w-5xl mx-auto flex flex-wrap p-5 flex-col md:flex-row">
        <div className="flex flex-row items-center justify-between p-3 md:p-1">
          <Link
            href="/"
            className="flex text-3xl text-p1 font-medium mb-4 md:mb-0"
          >Nobrac.
          </Link>
          <button
        ...
        >
          <div className="md:ml-auto md:mr-auto font-4 pt-1 md:pl-14 pl-1 flex flex-wrap items-center md:text-base text-1xl md:justify-center justify-items-start">
            <Link href="/buy" className="mr-11 pr-2 cursor-pointer text-gray-300 hover:text-white font-semibold tr04">
              Buy
            </Link>
            <Link href="/calculator" className="mr-12 cursor-pointer text-gray-300 hover:text-white font-semibold tr04">
              Calculator
            </Link>
            <Link href="/ranking" className="mr-12 cursor-pointer text-gray-300 hover:text-white font-semibold tr04">
              Ranking
            </Link>
